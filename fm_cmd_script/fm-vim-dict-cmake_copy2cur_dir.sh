...
{
	local dic_file_path=${fengming_dir}/documents/sub_doc_cmake/vim_dictionary_for_cmake
	...
	local snippet_file_path=${fengming_dir}/documents/sub_doc_systemd/vim_snippets_for_cmake
