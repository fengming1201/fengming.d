...
{
	local dic_file_path=${fengming_dir}/documents/sub_doc_docker/Dockerfile/vim_dictionary_for_dockerfile
	...
	local snippet_file_path=${fengming_dir}/documents/sub_doc_systemd/vim_snippets_for_dockerfile
